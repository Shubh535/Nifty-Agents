...
app = typer.Typer(
    name="NiftyAgents",
    help="NiftyAgents CLI: Multi-Agents LLM Financial Trading Framework",
...
def update_display(layout, spinner_text=None, stats_handler=None, start_time=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to NiftyAgents CLI[/bold green]\n"
            "[dim]Multi-Agents LLM Financial Trading Framework[/dim]",
            title="Welcome to NiftyAgents",
            border_style="green",
            padding=(1, 2),
            expand=True,
        )
...
def get_user_selections():
    ...
    welcome_content += "[bold green]NiftyAgents: Multi-Agents LLM Financial Trading Framework - CLI[/bold green]\n\n"
